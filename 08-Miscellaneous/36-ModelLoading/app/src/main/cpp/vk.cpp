...
bool bDone = false;
const char* gpszAppName = "Vulkan Android NDK - Black White Cube";
int winWidth = 0;
int winHeight = 0;
...
VkResult initialize(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createIndexBuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createIndexBuffer() Successful!.\n\n");
    }
...
void uninitialize(Engine* engine) {
    ...
    if(pElements) {
        free(pElements);
        pElements = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): freed pElements!.\n");
    }

    if(pTexCoords) {
        free(pTexCoords);
        pTexCoords = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): freed pTexCoords!.\n");
    }

    if(pNormals) {
        free(pNormals);
        pNormals = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): freed pNormals!.\n");
    }

    if(pPositions) {
        free(pPositions);
        pPositions = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): freed pPositions!.\n");
    }

    // Destroy Vertex Buffer Position
    if(vertexData_position.vkDeviceMemory) {
        vkFreeMemory(vkDevice, vertexData_position.vkDeviceMemory, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Position!\n");
    ...
    if(vertexData_position.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Position!\n");
    ...
    if(vertexData_normal.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Normal!\n");
    ...
    if(vertexData_normal.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Normal!\n");
    ...
    if(vertexData_elements.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Index Buffer!\n");
    ...
    if(vertexData_elements.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyBuffer() Succeed for Index Buffer!\n");
...
VkResult createIndexBuffer(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkCreateBuffer() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkCreateBuffer() Successful for Index Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkAllocateMemory() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkAllocateMemory() Successful for Index Buffer!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_elements.vkBuffer, vertexData_elements.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkBindBufferMemory() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkBindBufferMemory() Successful for Index Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkMapMemory() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer(): vkMapMemory() Successful for Index Buffer!.\n");
    }
...
VkResult createVertexBuffer(void) {
   // variables
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Successful for Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Successful for Position!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_position.vkBuffer, vertexData_position.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Successful for Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Successful for Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Successful for Normals!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Successful for Normals!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_normal.vkBuffer, vertexData_normal.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Successful for Normals!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Successful for Normals!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Successful for Texcoords!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Successful for Texcoords!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord.vkBuffer, vertexData_texcoord.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Successful for Texcoords!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Successful for Texcoords!.\n");
    }
...
VkResult createTexture(const char*  textureFileName) {
    ...
    // close asset as we have loaded the data in memory
    AAsset_close(asset);
    asset = NULL;
