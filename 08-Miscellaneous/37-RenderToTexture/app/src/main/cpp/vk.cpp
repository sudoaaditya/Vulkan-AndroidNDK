...
bool bDone = false;
const char* gpszAppName = "Vulkan Android NDK - Render To Texture";
int winWidth = 0;
int winHeight = 0;
...
VkResult initialize(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createSwapchainImagesAndImageViews_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createSwapchainImagesAndImageViews_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createCommandBuffers_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createCommandBuffers_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createVertexBuffer_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createVertexBuffer_fbo() Successful!.\n\n");
    }

    // Create Index Buffer
    vkResult = createIndexBuffer_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createIndexBuffer_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createIndexBuffer_fbo() Successful!.\n\n");
    }

    // Create Texture
    vkResult = createTexture("Marble.png");
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createTexture() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createTexture() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createUniformBuffer_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createUniformBuffer_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createShaders_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createShaders_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createDescriptorSetLayout_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createDescriptorSetLayout_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createPipelineLayout_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createPipelineLayout_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createDescriptorPool_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createDescriptorPool_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createDescriptorSet_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createDescriptorSet_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createRenderPass_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createRenderPass_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createPipeline_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createPipeline_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createFramebuffer_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createFramebuffer_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createSemaphore_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createSemaphore_fbo() Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): buildCommandBuffer_fbo() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): buildCommandBuffer_fbo() Successful!.\n\n");
    }
...
VkResult resize(int width, int height) {
    ...
    vkResult = createDescriptorSet();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize(): createDescriptorSet() Failed!.\n");
        return (vkResult);
    }
...
VkResult display(void) {
    ...
    if(bInitialized_fbo == false) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "display(): bInitialized_fbo is false!.\n");
        return (vkResult);
    }
    if(bInitialized == false) {
        vkResult = (VkResult)VK_FALSE;
    ...
    if(vkResult != VK_SUCCESS && vkResult != VK_SUBOPTIMAL_KHR) {
        if(vkResult == VK_ERROR_OUT_OF_DATE_KHR) {
            ...
            if(vkResult != VK_SUCCESS) {
                __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "display(): resize_fbo() Failed!.\n");
                return (vkResult);
            }
        } else {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "display(): vkQueueSubmit() Failed for FBO!.\n");
        return (vkResult);
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "display(): updateUniformBuffer_fbo() Failed!.\n");
        return (vkResult);
    }
...
void uninitialize(Engine* engine) {
    ...
    if(vkSampler_texture) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroySampler() Succeed for Texture Sampler!\n");
    ...
    if(vkImageView_texture) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyImageView() Succeed for Texture Image View!\n");
    ...
    if(vkDeviceMemory_texture) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Texture Image Memory!\n");
    ...
    if(vkImage_texture) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyImage() Succeed for Texture Image!\n");
    ...
    if(vertexData_texcoord.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for TexCoord!\n");
    ...
    if(vertexData_texcoord.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for TexCoord!\n");
    ...
    if(vkImageView_depth) {
        vkDestroyImageView(vkDevice, vkImageView_depth, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyImageView() Succeed for Depth Stencil Image View!\n");
        vkImageView_depth = VK_NULL_HANDLE;
    }
    ...
    if(vkImage_depth) {
        vkDestroyImage(vkDevice, vkImage_depth, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyImage() Succeed for Depth Stencil Image!\n");
        vkImage_depth = VK_NULL_HANDLE;
    }
    ...
    if(vkDeviceMemory_depth) {
        vkFreeMemory(vkDevice, vkDeviceMemory_depth, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Depth Stencil Memory!\n");
        vkDeviceMemory_depth = VK_NULL_HANDLE;
    }
...
VkResult createSwapchainImagesAndImageViews(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): getSupportedDepthFormat() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): getSupportedDepthFormat() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkCreateImage() Failed for Depth Image!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkCreateImage() Successful for Depth Image!.\n");
    }
    ...
    for(uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++) {
        ...
        if((vkMemoryRequirements.memoryTypeBits & 1) == 1) {
            // Step C
            if(vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT & VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT) {
                // Step D
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkAllocateMemory() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkAllocateMemory() Successful!.\n");
    }

    // Step 10
    vkResult = vkBindImageMemory(vkDevice, vkImage_depth, vkDeviceMemory_depth, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkBindDev() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkBindDev() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkCreateImageView() Failed for Depth Image!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews(): vkCreateImageView() Successful for Depth Image!.\n");
    }
...
VkResult getSupportedDepthFormat(void) {
    ...
    for(uint32_t i = 0; i < sizeof(vkFormat_depth_array) / sizeof(vkFormat_depth_array[0]); i++) {
        ...
        if(vkFormatProperties.optimalTilingFeatures & VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT) {
            ...
            __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "getSupportedDepthFormat(): Supported Depth Format Found: %d\n", vkFormat_depth);
            vkResult = VK_SUCCESS;
            break;
        }
    }
...
VkResult createVertexBuffer(void) {
   ...
   float cube_position[] = {
    ...
    // VertexData for Triangle Texture
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Failed for TexCoord!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Successful for TexCoord!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Failed for TexCoord!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Successful for TexCoord!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord.vkBuffer, vertexData_texcoord.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Failed for TexCoord!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Successful for TexCoord!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Failed for TexCoord!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Successful for TexCoord!.\n");
    }
...
VkResult createShaders(void) {
    ...
    // for vertex shader
    const char* szFileName = "shader_cube.vert.spv";
    size_t fileSize = 0;
    AAsset *asset = NULL;
    ...
    // for fragment shader
    szFileName = "shader_cube.frag.spv";
    fileSize = 0;
...
// Vertex Input Binding Description [ Vertex Input State]
    ...
    vkGraphicsPipelineCreateInfo.pDepthStencilState = &vkPipelineDepthStencilStateCreateInfo; // we have depth stencil state
...
VkResult resize_fbo(int fbo_width, int fbo_height) {
    ...
    // If control comes here before initialization is done, then return false
    if(bInitialized_fbo == false) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): initialization is not completed or failed\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    ...
    // Check if vkSwapchainKHR is NULL, if it is NULL then we cannot proceed
    if(vkSwapchainKHR == VK_NULL_HANDLE) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): vkSwapchainKHR is NULL cannot proceed!.\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    ...
    vkResult = createSwapchainImagesAndImageViews_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): createSwapchainImagesAndImageViews_fbo() Failed!.\n");
        return (vkResult);
    }
    ...
    vkResult = createRenderPass_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): createRenderPass_fbo() Failed!.\n");
        return (vkResult);
    }
    ...
    vkResult = createPipelineLayout_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): createPipelineLayout_fbo() Failed!.\n");
        return (vkResult);
    }
    ...
    vkResult = createPipeline_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): createPipeline_fbo() Failed!.\n");
        return (vkResult);
    }
    ...
    vkResult = createFramebuffer_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): createFramebuffer_fbo() Failed!.\n");
        return (vkResult);
    }
    ...
    vkResult = createCommandBuffers_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): createCommandBuffers_fbo() Failed!.\n");
        return (vkResult);
    }
    ...
    vkResult = buildCommandBuffer_fbo();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "resize_fbo(): buildCommandBuffer_fbo() Failed!.\n");
        return (vkResult);
    }
...
void uninitialize_fbo(void){
    ...
    if(vkSemaphore_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroySemaphore() for Render Complete Succeed!\n");
    ...
    if(vkFramebuffer_fbo) {
        vkDestroyFramebuffer(vkDevice, vkFramebuffer_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyFramebuffer() Succeed!.\n");
        vkFramebuffer_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkPipeline_fbo) {
        vkDestroyPipeline(vkDevice, vkPipeline_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyPipeline() Succeed!\n");
        vkPipeline_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkRenderPass_fbo) {
        vkDestroyRenderPass(vkDevice, vkRenderPass_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyRenderPass() Succeed!\n");
        vkRenderPass_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkDescriptorPool_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDescriptorPool_fbo & vkDescriptorSet_fbo Destroy Succeed!\n");
    ...
    if(vkPipelineLayout_fbo) {
        vkDestroyPipelineLayout(vkDevice, vkPipelineLayout_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyPipelineLayout() Succeed!\n");
        vkPipelineLayout_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkDescriptorSetLayout_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyDescriptorSetLayout() Succeed!\n");
    ...
    if(vkShaderModule_fragment_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyShaderModule() Succeed for Fragment Shader!\n");
    ...
    if(vkShaderModule_vertex_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyShaderModule() Succeed for Vertex Shader!\n");
    ...
    if(uniformData_fbo.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Uniform Buffer!\n");
    ...
    if(uniformData_fbo.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyBuffer() Succeed for Uniform Buffer!\n");
    ...
    if(vkSampler_texture_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroySampler() Succeed for Texture Sampler!\n");
    ...
    if(vkImageView_texture_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyImageView() Succeed for Texture Image View!\n");
    ...
    if(vkDeviceMemory_texture_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Texture Image Memory!\n");
    ...
    if(vkImage_texture_fbo) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyImage() Succeed for Texture Image!\n");
    ...
    if(pElements) {
        free(pElements);
        pElements = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): freed pElements!.\n");
    }

    if(pTexCoords) {
        free(pTexCoords);
        pTexCoords = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): freed pTexCoords!.\n");
    }

    if(pNormals) {
        free(pNormals);
        pNormals = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): freed pNormals!.\n");
    }

    if(pPositions) {
        free(pPositions);
        pPositions = NULL;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): freed pPositions!.\n");
    }
    ...
    if(vertexData_position_fbo.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Vertex Buffer for Position!\n");
    ...
    if(vertexData_position_fbo.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyBuffer() Succeed for Vertex Buffer for Position!\n");
    ...
    if(vertexData_normal_fbo.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Vertex Buffer for Normal!\n");
    ...
    if(vertexData_normal_fbo.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyBuffer() Succeed for Vertex Buffer for Normal!\n");
    ...
    if(vertexData_elements_fbo.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Index Buffer!\n");
    ...
    if(vertexData_elements_fbo.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyBuffer() Succeed for Index Buffer!\n");
    ...
    if(vertexData_texcoord_fbo.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Vertex Buffer for Texcoord!\n");
    ...
    if(vertexData_texcoord_fbo.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyBuffer() Succeed for Vertex Buffer for Texcoord!\n");
    ...
    if(vkCommandBuffer_fbo) {
        vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_fbo);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeCommandBuffers() Succeed!\n");
        vkCommandBuffer_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkImageView_depth_fbo) {
        vkDestroyImageView(vkDevice, vkImageView_depth_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyImageView() Succeed for Depth Stencil Image View!\n");
        vkImageView_depth_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkImage_depth_fbo) {
        vkDestroyImage(vkDevice, vkImage_depth_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyImage() Succeed for Depth Stencil Image!\n");
        vkImage_depth_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkDeviceMemory_depth_fbo) {
        vkFreeMemory(vkDevice, vkDeviceMemory_depth_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for Depth Stencil Memory!\n");
        vkDeviceMemory_depth_fbo = VK_NULL_HANDLE;
    }
    ...
    if(vkSampler_fbo){
        vkDestroySampler(vkDevice, vkSampler_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroySampler() Succeed for FBO Sampler!\n");
        vkSampler_fbo = VK_NULL_HANDLE;
    }

    if(vkImageView_fbo){
        vkDestroyImageView(vkDevice, vkImageView_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyImageView() Succeed for FBO Image View!\n");
        vkImageView_fbo = VK_NULL_HANDLE;
    }

    if(vkDeviceMemory_fbo){
        vkFreeMemory(vkDevice, vkDeviceMemory_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkFreeMemory() Succeed for FBO Image Memory!\n");
        vkDeviceMemory_fbo = VK_NULL_HANDLE;
    }

    if(vkImage_fbo){
        vkDestroyImage(vkDevice, vkImage_fbo, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize_fbo(): vkDestroyImage() Succeed for FBO Image!\n");
        vkImage_fbo = VK_NULL_HANDLE;
    }
}
...
VkResult createSwapchainImagesAndImageViews_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImage() Failed for FBO Image!.\n");
        return(vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImage() Successful for FBO Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkAllocateMemory() Failed for FBO Image!.\n");
        return(vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkAllocateMemory() Successful for FBO Image!.\n");
    }

    vkResult = vkBindImageMemory(vkDevice, vkImage_fbo, vkDeviceMemory_fbo, 0);
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkBindImageMemory() Failed for FBO Image!.\n");
        return(vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkBindImageMemory() Successful for FBO Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImageView() Failed for FBO Image!.\n");
        return (vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImageView() Successful for FBO Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateSampler() Failed for FBO Sampler!.\n");
        return (vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateSampler() Successful for FBO Sampler!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImage() Failed for Depth Image!.\n");
        return (vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImage() Successful for Depth Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkAllocateMemory() Failed!.\n");
        return (vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkAllocateMemory() Successful!.\n");
    }

    // Step 10
    vkResult = vkBindImageMemory(vkDevice, vkImage_depth_fbo, vkDeviceMemory_depth_fbo, 0);
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkBindDev() Failed!.\n");
        return (vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkBindDev() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImageView() Failed for Depth Image!.\n");
        return (vkResult);
    } else {
       __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSwapchainImagesAndImageViews_fbo(): vkCreateImageView() Successful for Depth Image!.\n");
    }
...
VkResult createCommandBuffers_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createCommandBuffers_fbo(): vkCreatvkAllocateCommandBufferseImageView() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createCommandBuffers_fbo(): vkAllocateCommandBuffers() Successful!.\n");
    }
...
VkResult createVertexBuffer_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkCreateBuffer() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkCreateBuffer() Successful for Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkAllocateMemory() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkAllocateMemory() Successful for Position!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_position_fbo.vkBuffer, vertexData_position_fbo.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkBindBufferMemory() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkBindBufferMemory() Successful for Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkMapMemory() Failed for Position!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkMapMemory() Successful for Position!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkCreateBuffer() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkCreateBuffer() Successful for Normals!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkAllocateMemory() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkAllocateMemory() Successful for Normals!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_normal_fbo.vkBuffer, vertexData_normal_fbo.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkBindBufferMemory() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkBindBufferMemory() Successful for Normals!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkMapMemory() Failed for Normals!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkMapMemory() Successful for Normals!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkCreateBuffer() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkCreateBuffer() Successful for Texcoords!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkAllocateMemory() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkAllocateMemory() Successful for Texcoords!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord_fbo.vkBuffer, vertexData_texcoord_fbo.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkBindBufferMemory() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkBindBufferMemory() Successful for Texcoords!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkMapMemory() Failed for Texcoords!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer_fbo(): vkMapMemory() Successful for Texcoords!.\n");
    }
...
VkResult createIndexBuffer_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkCreateBuffer() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkCreateBuffer() Successful for Index Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkAllocateMemory() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkAllocateMemory() Successful for Index Buffer!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_elements_fbo.vkBuffer, vertexData_elements_fbo.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkBindBufferMemory() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkBindBufferMemory() Successful for Index Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkMapMemory() Failed for Index Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createIndexBuffer_fbo(): vkMapMemory() Successful for Index Buffer!.\n");
    }
...
VkResult createTexture(const char*  textureFileName) {
    ...
    //Code!
    // Step 1: Get ImageDat using Asset Manager
    AAsset* asset = AAssetManager_open(androidAssetManager, textureFileName, AASSET_MODE_BUFFER);
    if(asset == NULL) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): AAssetManager_open() Failed for file: %s\n", textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): AAssetManager_open() Successful for file: %s\n", textureFileName);
    }

    const unsigned char* texFileData = (const unsigned char*)AAsset_getBuffer(asset);
    if(texFileData == NULL) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): AAsset_getBuffer() Failed for file: %s\n", textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        AAsset_close(asset);
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): AAsset_getBuffer() Successful for file: %s\n", textureFileName);
    }

    off_t texDataLength = AAsset_getLength(asset);
    
    uint8_t *image_data = NULL;
    int texture_width, texture_height, texture_channels;

    image_data = stbi_load_from_memory(texFileData, (int)texDataLength, &texture_width, &texture_height, &texture_channels, STBI_rgb_alpha);
    if(image_data == NULL || texture_width <= 0 || texture_height <= 0 || texture_channels <= 0) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Failed to load texture image data from stbi_load_from_memory for file: %s\n", textureFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        AAsset_close(asset);
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Texture Image Loaded Successfully from stbi_load_from_memory for file: %s\n", textureFileName);
    } 

    VkDeviceSize image_size = texture_width * texture_height * 4; // 4 channels (RGBA)

    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Texture Image Loaded Successfully! Width: %d, Height: %d, Channels: %d, Size: %llu bytes\n", 
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateBuffer() Failed for Staging Buffer!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateBuffer() Successful for Staging Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateMemory() Failed for Staging Buffer!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateMemory() Successful for Staging Buffer!.\n");
    }

    vkBindBufferMemory(vkDevice, vkBuffer_stagingBuffer, vkDeviceMemory_stagingBuffer, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBindBufferMemory() Failed for Staging Buffer!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBindBufferMemory() Successful for Staging Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkMapMemory() Failed for Staging Buffer!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkMapMemory() Successful for Staging Buffer!.\n");
    }
    ...
    image_data = NULL;
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Image Data Copied to Staging Buffer Successful & Freed stbi Image Data!.\n");
    AAsset_close(asset);
    asset = NULL;
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateImage() Failed for Texture Image!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateImage() Successful for Texture Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateMemory() Failed for Texture Image!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateMemory() Successful for Texture Image!.\n");
    }

    vkResult = vkBindImageMemory(vkDevice, vkImage_texture_fbo, vkDeviceMemory_texture_fbo, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBindImageMemory() Failed for Texture Image!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBindImageMemory() Successful for Texture Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateCommandBuffers() Failed for Transition Image Layout!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateCommandBuffers() Successful for Transition Image Layout!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBeginCommandBuffer() Failed for Transition Image Layout!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBeginCommandBuffer() Successful for Transition Image Layout!.\n");
    }
    ...
    if(vkImageMemoryBarrier.oldLayout == VK_IMAGE_LAYOUT_UNDEFINED && vkImageMemoryBarrier.newLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Unsuppored Texture Layout Transition!.\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkEndCommandBuffer() Failed for Transition Image Layout!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkEndCommandBuffer() Successful for Transition Image Layout!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueSubmit() Failed for Transition Image Layout!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueSubmit() Successful for Transition Image Layout!.\n");
    }

    vkResult = vkQueueWaitIdle(vkQueue);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueWaitIdle() Failed for Transition Image Layout!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueWaitIdle() Successful for Transition Image Layout!.\n");
    }
    ...
    if(vkCommandBuffer_transition_image_layout){ 
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkFreeCommandBuffers() Successful for Transition Image Layout!.\n");
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateCommandBuffers() Failed for Buffer to Image Copy!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateCommandBuffers() Successful for Buffer to Image Copy!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBeginCommandBuffer() Failed for Buffer to Image Copy!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBeginCommandBuffer() Successful for Buffer to Image Copy!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkEndCommandBuffer() Failed for Buffer to Image Copy!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkEndCommandBuffer() Successful for Buffer to Image Copy!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueSubmit() Failed for Buffer to Image Copy!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueSubmit() Successful for Buffer to Image Copy!.\n");
    }

    vkResult = vkQueueWaitIdle(vkQueue);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueWaitIdle() Failed for Buffer to Image Copy!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueWaitIdle() Successful for Buffer to Image Copy!.\n");
    }
    ...
    if(vkCommandBuffer_buffer_to_image_copy){ 
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkFreeCommandBuffers() Successful for Buffer to Image Copy!.\n");
    ...
    vkResult = vkAllocateCommandBuffers(vkDevice, &vkCommandBufferAllocateInfo_transition_image_layout, &vkCommandBuffer_transition_image_layout);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateCommandBuffers() Failed for Transition Image Layout for Shaders!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkAllocateCommandBuffers() Successful for Transition Image Layout for Shaders!.\n");
    }
    ...
    vkResult = vkBeginCommandBuffer(vkCommandBuffer_transition_image_layout, &vkCommandBufferBeginInfo_transition_image_layout);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBeginCommandBuffer() Failed for Transition Image Layout for Shaders!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkBeginCommandBuffer() Successful for Transition Image Layout for Shaders!.\n");
    }
    ...
    if(vkImageMemoryBarrier.oldLayout == VK_IMAGE_LAYOUT_UNDEFINED && vkImageMemoryBarrier.newLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Unsuppored Texture Layout Transition for Shaders!.\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    }
    ...
    vkResult = vkEndCommandBuffer(vkCommandBuffer_transition_image_layout);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkEndCommandBuffer() Failed for Transition Image Layout for Shaders!.\n");
        return(vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkEndCommandBuffer() Successful for Transition Image Layout for Shaders!.\n");
    }
    ...
    vkResult = vkQueueSubmit(vkQueue, 1, &vkSubmitInfo_image_transition_layout, VK_NULL_HANDLE);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueSubmit() Failed for Transition Image Layout for Shaders!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueSubmit() Successful for Transition Image Layout for Shaders!.\n");
    }

    vkResult = vkQueueWaitIdle(vkQueue);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueWaitIdle() Failed for Transition Image Layout for Shaders!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkQueueWaitIdle() Successful for Transition Image Layout for Shaders!.\n");
    }

    if(vkCommandBuffer_transition_image_layout){ 
        vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_transition_image_layout);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkFreeCommandBuffers() Successful for Transition Image Layout for Shaders!.\n");
        vkCommandBuffer_transition_image_layout = VK_NULL_HANDLE;
    }
    ...
    if(vkBuffer_stagingBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkFreeMemory() Successful for Staging Buffer!.\n");
        vkDeviceMemory_stagingBuffer = VK_NULL_HANDLE;
    }
    if(vkBuffer_stagingBuffer) {
        vkDestroyBuffer(vkDevice, vkBuffer_stagingBuffer, NULL);
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkDestroyBuffer() Successful for Staging Buffer!.\n");
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateImageView() Failed for Texture Image!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateImageView() Successful for Texture Image!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateSampler() Failed for Texture Sampler!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): vkCreateSampler() Successful for Texture Sampler!.\n");
    }
...
VkResult createUniformBuffer_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): vkCreateBuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): vkCreateBuffer() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): vkAllocateMemory() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): vkAllocateMemory() Successful!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_fbo.vkBuffer, uniformData_fbo.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): vkBindBufferMemory() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): vkBindBufferMemory() Successful!.\n");
    }

    // call updateUniformBuffer() to fill the uniform buffer with data
    vkResult = updateUniformBuffer();
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): updateUniformBuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer_fbo(): updateUniformBuffer() Successful!.\n");
    }
...
VkResult updateUniformBuffer_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "updateUniformBuffer_fbo(): vkMapMemory() Failed!.\n");
        return (vkResult);
    }
...
VkResult createShaders_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders_fbo(): vkCreateShaderModule() for Vertex Shader Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders_fbo(): vkCreateShaderModule() for Vertex Shader Successful!.\n");
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders_fbo(): Vertex Shader Module Created Successful!.\n");
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders_fbo(): vkCreateShaderModule() for Fragment Shader Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders_fbo(): vkCreateShaderModule() for Fragment Shader Successful!.\n");
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders_fbo(): Fragment Shader Module Created Successful!.\n");
...
VkResult createDescriptorSetLayout_fbo(void) {
   // Variables
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSetLayout_fbo(): vkCreateDescriptorSetLayout() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSetLayout_fbo(): vkCreateDescriptorSetLayout() Successful!.\n");
    }
...
VkResult createPipelineLayout_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createPipelineLayout_fbo(): vkCreatePipelineLayout() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createPipelineLayout_fbo(): vkCreatePipelineLayout() Successful!.\n");
    }
...
VkResult createDescriptorPool_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorPool_fbo(): vkCreateDescriptorPool() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorPool_fbo(): vkCreateDescriptorPool() Successful!.\n");
    }
...
VkResult createDescriptorSet_fbo(void) { 
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet_fbo(): vkAllocateDescriptorSets() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet_fbo(): vkAllocateDescriptorSets() Successful!.\n");
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet_fbo(): vkUpdateDescriptorSets() Successful!.\n");
...
VkResult createRenderPass_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createRenderPass_fbo(): vkCreateRenderPass() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createRenderPass_fbo(): vkCreateRenderPass() Successful!.\n");
    }
...
VkResult createPipeline_fbo(void) {
    ...
    vkResult = vkCreatePipelineCache(vkDevice, &vkPipelineCacheCreateInfo, NULL, &vkPipelineCache);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createPipeline_fbo(): vkCreatePipelineCache() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createPipeline_fbo(): vkCreatePipelineCache() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createPipeline_fbo(): vkCreateGraphicsPipelines() Failed!.\n");
        // Destroy Pipeline Cache
        vkDestroyPipelineCache(vkDevice, vkPipelineCache, NULL);
        vkPipelineCache = VK_NULL_HANDLE;
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createPipeline_fbo(): vkCreateGraphicsPipelines() Successful!.\n");
    }
...
VkResult createFramebuffer_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createFramebuffer_fbo(): vkCreateFramebuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createFramebuffer_fbo(): vkCreateFramebuffer() Successful!.\n");
    }
...
VkResult createSemaphore_fbo(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSemaphore_fbo(): vkCreateSemaphore() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createSemaphore_fbo(): vkCreateSemaphore() Successful!.\n");
    }
...
VkResult buildCommandBuffer_fbo(void) {
    ...
    // adding 0 here means sdon't release resources allocated by command pool
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "buildCommandBuffer_fbo(): vkResetCommandBuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "buildCommandBuffer_fbo(): vkResetCommandBuffer() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "buildCommandBuffer_fbo(): vkBeginCommandBuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "buildCommandBuffer_fbo(): vkBeginCommandBuffer() Successful!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "buildCommandBuffer_fbo(): vkEndCommandBuffer() Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "buildCommandBuffer_fbo(): vkEndCommandBuffer() Successful!.\n");
    }
