...
bool bDone = false;
const char* gpszAppName = "Vulkan Android NDK - Geometry Shader";
int winWidth = 0;
int winHeight = 0;
...
void uninitialize(Engine* engine) {
    ...
    if(vkShaderModule_geometry) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyShaderModule() Succeed for Geometry Shader!\n");
...
VkResult createVulkanDevice () {
    ...
    if(vkPhysicalDeviceFeatures.geometryShader == VK_TRUE) {
        ...
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVulkanDevice(): Selected Physical Device Does Not Supports Geometry Shader!.\n");
        return (vkResult);
    }
...
VkResult createShaders(void) {
    ...
    asset = AAssetManager_open(androidAssetManager, szFileName, AASSET_MODE_BUFFER);
    if(asset == NULL) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): AAssetManager_open() failed to open Geometry Shader spir-v file!.\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): AAssetManager_open() succeed to open Geometry Shader spir-v file!.\n");
    }
    ...
    if(retVal != fileSize) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): AAsset_read() failed to read Geometry Shader file!.\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): AAsset_read() succeed to read Geometry Shader file!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): vkCreateShaderModule() for Geometry Shader Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): vkCreateShaderModule() for Geometry Shader Successful!.\n");
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createShaders(): Geometry Shader Module Created Successful!.\n");
