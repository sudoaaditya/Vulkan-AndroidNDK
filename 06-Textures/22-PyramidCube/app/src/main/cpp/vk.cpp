...
VkResult initialize(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createTexture() for Cube Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createTexture() for Cube Successful!.\n\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {    
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createTexture() for Pyramid Failed!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "initialize(): createTexture() for Pyramid Successful!.\n\n");
    }
...
VkResult createVertexBuffer(void) {
    ...
    vkResult = vkMapMemory(
        vkDevice,
        vertexData_texcoord_pyramid.vkDeviceMemory,
        0,
        vkMemoryAllocateInfo.allocationSize,
        0,
        &data
    ...
    vkResult = vkMapMemory(
        vkDevice,
        vertexData_texcoord_cube.vkDeviceMemory,
        0,
        vkMemoryAllocateInfo.allocationSize,
        0,
        &data
...
VkResult createUniformBuffer (void) {
   // functions
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Failed for Pyramid!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Successful for Pyramid!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Failed for Pyramid!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Successful for Pyramid!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_pyramid.vkBuffer, uniformData_pyramid.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Failed for Pyramid!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Successful for Pyramid!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Failed for Cube!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Successful for Cube!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Failed for Cube!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Successful for Cube!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_cube.vkBuffer, uniformData_cube.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Failed for Cube!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Successful for Cube!.\n");
    }
...
VkResult updateUniformBuffer(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "updateUniformBuffer(): vkMapMemory() Failed for Pyramid!.\n");
        return (vkResult);
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "updateUniformBuffer(): vkMapMemory() Failed for Cube!.\n");
        return (vkResult);
    }
...
VkResult createDescriptorPool(void) {
    // Variables
    VkResult vkResult = VK_SUCCESS;
    const uint32_t objectDescriptorSetCount = 2;
    ...
    vkDescriptorPoolSize_array[0].descriptorCount = objectDescriptorSetCount;

    // for texture sampler
    vkDescriptorPoolSize_array[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    vkDescriptorPoolSize_array[1].descriptorCount = objectDescriptorSetCount;
    ...
    vkDescriptorPoolCreateInfo.maxSets = objectDescriptorSetCount;
...
VkResult createDescriptorSet(void) {
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkUpdateDescriptorSets() Successful for Pyramid!.\n");
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkUpdateDescriptorSets() Successful for Cube!.\n");
