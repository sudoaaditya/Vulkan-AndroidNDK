...
bool bDone = false;
const char* gpszAppName = "Vulkan Android NDK - Checkerboard Texture";
int winWidth = 0;
int winHeight = 0;
...
// For checkerboard
jbyte checkerBoard[CHECKERBOARD_HEIGHT][CHECKERBOARD_WIDTH][4];
...
void uninitialize(Engine* engine) {
    ...
    if(vkDescriptorPool) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDescriptorPool & vkDescriptorSet_straight & vkDescriptorSet_oblique Destroy Succeed!\n");
...
void makeCheckImage(void) {
    ...
    for(i = 0; i < CHECKERBOARD_HEIGHT; i++) {
        for(j = 0; j < CHECKERBOARD_WIDTH; j++) {
            ...
            checkerBoard[i][j][0] = (jbyte)c;
            checkerBoard[i][j][1] = (jbyte)c;
            checkerBoard[i][j][2] = (jbyte)c;
            checkerBoard[i][j][3] = (jbyte)255;
        }
    }
}
...
VkResult createTexture() {
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Texture Image Loaded Successfully! Width: %d, Height: %d, Size: %llu bytes\n", 
    ...
    image_data = NULL;
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createTexture(): Image Data Copied to Staging Buffer Successful!.\n");
...
VkResult createUniformBuffer (void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Failed for Straight Uniform Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Successful for Straight Uniform Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Failed for Straight Uniform Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Successful for Straight Uniform Buffer!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_straight.vkBuffer, uniformData_straight.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Failed for Straight Uniform Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Successful for Straight Uniform Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Failed for Oblique Uniform Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkCreateBuffer() Successful for Oblique Uniform Buffer!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Failed for Oblique Uniform Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkAllocateMemory() Successful for Oblique Uniform Buffer!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, uniformData_oblique.vkBuffer, uniformData_oblique.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Failed for Oblique Uniform Buffer!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createUniformBuffer(): vkBindBufferMemory() Successful for Oblique Uniform Buffer!.\n");
    }
...
VkResult createDescriptorPool(void) {
    ...
    vkDescriptorPoolSize_array[0].descriptorCount = 2; // we have only one uniform buffer

    // for texture sampler
    vkDescriptorPoolSize_array[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    vkDescriptorPoolSize_array[1].descriptorCount = 2; // we have only one texture sampler
...
VkResult createDescriptorSet(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkAllocateDescriptorSets() Failed for straight descriptor set!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkAllocateDescriptorSets() Successful for straight descriptor set!.\n");
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkUpdateDescriptorSets() Successful for straight descriptor set!.\n");
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkAllocateDescriptorSets() Failed for oblique descriptor set!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkAllocateDescriptorSets() Successful for oblique descriptor set!.\n");
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createDescriptorSet(): vkUpdateDescriptorSets() Successful for oblique descriptor set!.\n");
