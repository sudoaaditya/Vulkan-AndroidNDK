...
void uninitialize(Engine* engine) {
    ...
    if(vertexData_position_rectangle.vkDeviceMemory) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkFreeMemory() Succeed for Vertex Buffer for Rectangle!\n");
    ...
    if(vertexData_position_rectangle.vkBuffer) {
        ...
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "uninitialize(): vkDestroyBuffer() Succeed for Vertex Buffer for Rectangle!\n");
...
VkResult createVertexBuffer(void) {
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Successful for Triangle!.\n");
    }

    // Step 10
    vkResult = vkBindBufferMemory(vkDevice, vertexData_position_triangle.vkBuffer, vertexData_position_triangle.vkDeviceMemory, 0);
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Failed for Triangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Successful for Triangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkCreateBuffer() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkAllocateMemory() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkBindBufferMemory() Successful for Rectangle!.\n");
    }
    ...
    if(vkResult != VK_SUCCESS) {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Failed for Rectangle!.\n");
        return (vkResult);
    } else {
        __android_log_print(ANDROID_LOG_INFO, "AMK-Ndk:", "createVertexBuffer(): vkMapMemory() Successful for Rectangle!.\n");
    }
